...
const carouselData = [
  ...
  { image: require('../assets/images/Gladiador.jpg'), rating: 'Mayor de 12 años', status: 'En preventa' },
  { image: require('../assets/images/Venom.jpg'), rating: 'Todo Público', status: 'En cartelera' },
